...
public class Fallout {
    ...
    public void getRandomFall(final double random, final IMeteoriteWorld w, final int x, final int y, final int z) {
        ...
        if (random > 0.9) {
            ...
            this.putter.put(w, x, y, z, (list[2] == null ? w.getWorld().getBiomeGenForCoords(x, z).fillerBlock : list[2]), meta[2]);
        } else {
    ...
    public void getRandomInset(final double random, final IMeteoriteWorld w, final int x, final int y, final int z) {
        ...
        if (random > 0.9) {
            ...
            this.putter.put(w, x, y, z, (list[4] == null ? w.getWorld().getBiomeGenForCoords(x, z).topBlock : list[4]), meta[4]);
        } else if (random > 0.6) {
